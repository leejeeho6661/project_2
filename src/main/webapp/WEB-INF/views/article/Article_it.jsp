...
<%-- 날라온 리스트 사이즈 : ${article_list.size()} <br> --%>
<div class="containew-fluid">

	<div class="container" id="article_title">
		<img src="${rootPath}/img/article_it.JPG" id="article_it_img" alt="IT">
	</div>
		...
		<div class="article_board" id="article_board">
			...
			<c:if test="${not empty article_list || pageVO.listCount>0}">
				...
				<div class="item">
					...
					<!-- ${rootPath}/board_detail.do?board_num=${board.board_num}" id="boardNum_${board.board_num} -->
					</figure>
