...
<link rel="stylesheet" href="/project/css/member_agree.css" >

<jsp:include page="../Header.jsp"></jsp:include>
	<div class ="container">
	<form action="SignUp.do" method="post" onsubmit="return checkForm();">
	<img src="../img/member_agree.JPG" alt="약관동의" id="member_agree">
	<img src="../img/member_agree2.JPG" alt="약관동의" id="member_agree2">
	
	<fieldset>
		<h3 class="text-center agree-title"><strong>나만 몰랐던 NEWS 서비스 약관동의</strong></h3>
		<div class="col-sn-6 text-right">
			<input type="checkbox" name="agree" id="agree1">
		</div>
	<div class="form-group">	
	<textarea name="text" name="bContent" cols="60" rows="10" id="bContent" class="form-control"  readonly disabled>
	
			제 1 장 총 칙
제 1 조 목적
본 약관은 서비스 이용자가 나만 몰랐던 NEWS(이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유?무선 단말기의 종류와는 상관없이 이용 가능한 “회사”가 제공하는 모든 “서비스”를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 “회원”이라고 합니다)의 권리?의무 및 책임사항을 규정함을 목적으로 합니다.
...
⑤
정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 “정보통신망법”이라 합니다)의 규정에 의해 다른 회원의 공개된 게시물 등이 본인의 사생활을 침해하거나 명예를 훼손하는 등 권리를 침해 받은 회원 또는 제3자(이하 “삭제 등 신청인”이라 합니다)는 그 침해사실을 소명하여 회사에 해당 게시물 등의 삭제 또는 반박 내용의 게재를 요청할 수 있습니다.
 이 경우 회사는 해당 게시물 등의 권리 침해 여부를 판단할 수 없거나 당사자 간의 다툼이 예상되는 경우 해당 게시물 등에 대한 접근을 임시적으로 차단하는 조치(이하 “임시조치”라 합니다)를 최장 30일까지 취합니다.

⑥
제5항에 의해 본인의 게시물 등이 임시조치된 회원(이하 “게시자”라 합니다)은 임시조치기간 중 회사에 해당 게시물 등을 복원해 줄 것을 요청(이하 “재게시 청구”라 합니다)할 수 있으며, 회사는 임시조치된 게시물의 명예훼손 등 판단에 대한 방송통신심의위원회 심의 요청에 대한 게시자 및 삭제 등 신청인의 동의가 있는 경우 게시자 및 삭제 등 신청인을 
대리하여 이를 요청하고 동의가 없는 경우 회사가 이를 판단하여 게시물 등의 복원 여부를 결정합니다. 
게시자의 재게시 청구가 있는 경우 임시조치 기간 내에 방송통신심의위원회 또는 회사의 결정이 있으면 그 결정에 따르고 
그 결정이 임시조치 기간 내에 있지 않는 경우 해당 게시물 등은 임시조치 만료일 이후 복원됩니다. 재게시 청구가 없는 경우 해당 게시물 등은 임시조치 기간 만료 이후 삭제됩니다.
...
⑧
회원의 게시물 등으로 인한 법률상 이익 침해를 근거로, 다른 회원 또는 제3자가 회원 또는 회사를 대상으로 하여 민형사상의 법적 조치(예: 형사고소, 가처분 신청?손해배상청구 등 민사소송의 제기)를 취하는 경우, 회사는 동 법적 조치의 결과인 법원의 확정판결이 있을 때까지 관련 게시물 등에 대한 접근을 잠정적으로 제한할 수 있습니다. 
게시물 등의 접근 제한과 관련한 법적 조치의 소명, 
법원의 확정 판결에 대한 소명 책임은 게시물 등에 대한 조치를 요청하는 자가 부담합니다.
...
본 약관은 2016년 10월 7일부터 적용됩니다. 단, 본 약관의 공지 시점으로부터 적용일 전일까지 기간 동안에 가입한 신규회원에 대해서는 회원 가입시부터 본 약관이 적용됩니다.
	...
	<fieldset>
	<h3 class="text-center agree-title"><strong>나만 몰랐던 NEWS 개인정보 수집 및 이용 동의</strong></h3>
	<div class="col-sn-6 text-right">
	...
	<div class="form-group">
	<textarea name="text" name="bContent" cols="60" rows="10" id="bContent" class="form-control"  readonly disabled>
	나만 몰랐던 NEWS는 아래의 목적으로 개인정보를 수집 및 이용하며, 회원의 개인정보를 안전하게 취급하는데 최선을 다합니다.
1. 수집목적
2. 이용자 식별, 원활한 의사소통, 부정이용 시 제재 및 기록 
3. 회원제 서비스 제공, 문의사항 또는 불만 처리, 공지사항 전달 
4. 유료 서비스 이용 시 요금 정산 
5. 신규 서비스 개발, 이벤트 행사 시 정보 전달, 마케팅 및 광고 등에 활용 
6. 서비스 이용 기록 및 통계 분석을 통한 서비스 개선 및 맞춤형 서비스 제공 
7. 프라이버시 보호 측면의 서비스 환경 구축 
2. 수집항목
아이디, 비밀번호, 담당자 정보(본인확인정보(이름, 생년월일, 성별, 본인확인값(CI, DI)), 담당자 연락처(휴대폰번호, 이메일주소), 아이핀정보(아이핀 확인 시), 내/외국인 여부) 
3. 보유기간
...
더 자세한 내용에 대해서는 개인정보처리방침을 참고하시기 바랍니다.
	...
	<input type="submit" value="동의하기" class ="btn btn-secondary mt-2 mb-2" >
